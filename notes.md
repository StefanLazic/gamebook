...
**Шта је тражено:** сачувати постојећу причу, додати другу (Ема, 7 година, први дан
...
Ема, мама, тата, учитељица Јована, Вук, Тара, бака Даница, домар Мија и саобраћајац Раде.
...
**После рецензије кода:** дугме за наставак сада има поље `continueText` по причи, па Ема
добија „Настави где си стала“ (женски род), док прва прича задржава стари текст.
Исправљено и латинично „а“ које се увукло у један опис слике у `js/art-prvi.js`.
